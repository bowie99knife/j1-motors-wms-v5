    ...
    <>
      {!supabaseConfigured && (
        <div style={{
          ...
          Website preview mode: cloud database is not connected yet.
        </div>
      )}
      <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/dashboard/quotes" element={
          <ProtectedRoute><RoleGuard allowed={["admin"]}><QuoteRequests /></RoleGuard></ProtectedRoute>
        } />
        <Route path="/dashboard/revenue" element={
          <ProtectedRoute><RoleGuard allowed={["admin"]}><Revenue /></RoleGuard></ProtectedRoute>
        } />
        <Route path="/dashboard/staff" element={
          <ProtectedRoute><RoleGuard allowed={["admin"]}><StaffManagement /></RoleGuard></ProtectedRoute>
        } />
      </Route>
      </Routes>
    </>
